...
public class SpriteMap
{
    ...
    /**
     * Loads a decorative 'mapfile' that is contained in the given 'folder'. It is expected that
     * the animations associated with the map will also be in 'folder'.
     *
    ...
    public void updateDecorativeSprites(long time_elapsed) {
        Sprite sprite=null;
        for (int r=0; r<mapHeight; r++)
        {
            for (int c=0; c<mapWidth; c++)
